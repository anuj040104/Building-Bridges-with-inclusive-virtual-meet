...
class Application:
    ...
    def __init__(self):
        ...
        self.space = tk.Button(self.root)
        self.space.place(x=1205, y=700)
        self.space.config(text="Space", font=("Times New Roman", 20), wraplength=100, command=self.space_fun)

        self.delete = tk.Button(self.root)
        self.delete.place(x=1305, y=700)
        self.delete.config(text="Delete", font=("Times New Roman", 20), wraplength=100, command=self.delete_fun)
            ...
            if hands:
                ...
                if handz:
                    ...
                    if self.current_symbol != "blank":
                        ...
                        elif time.time() - start_time >= 3:  # 2 seconds threshold
                            self.str += self.current_symbol  # Add recognized character to sentence
                    ...
                    print("Panel2 updated after alphabet recognition.")
                else:
